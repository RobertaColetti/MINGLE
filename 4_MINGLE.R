...
# map: a data frame expressing the functional link between the NodesUL -- first column in the map -- and the new MINGLE Nodes -- first column in the map -- (map between CpG and genes in Coletti et al.).
